...
public abstract class Hilt_AddNewPhotoFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNewPhotoFragment_GeneratedInjector) this.generatedComponent()).injectAddNewPhotoFragment(UnsafeCasts.<AddNewPhotoFragment>unsafeCast(this));
    }
  }
