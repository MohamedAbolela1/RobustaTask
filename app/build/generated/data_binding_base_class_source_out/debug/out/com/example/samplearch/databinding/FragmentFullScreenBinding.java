...
public final class FragmentFullScreenBinding implements ViewBinding {
  ...
  private FragmentFullScreenBinding(@NonNull ConstraintLayout rootView,
      @NonNull CardView cardProduct, @NonNull AppCompatImageView imgProduct,
      @NonNull BackToolbarBinding toolbarDetails) {
  ...
  public static FragmentFullScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFullScreenBinding((ConstraintLayout) rootView, cardProduct, imgProduct,
          binding_toolbarDetails);
    }
