...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView imgProduct, @NonNull View separator, @NonNull TextView tvDate,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((ConstraintLayout) rootView, imgProduct, separator, tvDate,
          tvTitle);
    }
